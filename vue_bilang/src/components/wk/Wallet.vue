<template>
  <div class="all">
     <van-nav-bar title="我的钱包" left-text="返回" left-arrow class="head" @click-left="onClickLeft">
      <template #right>
  ...
  <div class="count">
     ...
     <p>
       <span class="li_1">账户余额</span>
       <span class="li_2">￥0.00</span>
     </p>
      <p>
       <span class="li_3">累计积分收益</span>
       <span class="li_4">1000</span>
     </p>
  </div>
  <div class="balance">
  <p>余额提现</p>
